...
if (isActionAccessible($guid, $connection2, '/modules/Deep Learning/enrolment_manage_byPerson_delete.php') == false) {
    ...
    // Proceed!
    $deepLearningEnrolmentID = $_GET['deepLearningEnrolmentID'] ?? '';

    if (empty($deepLearningEnrolmentID)) {
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Deep Learning/enrolment_manage_byPerson_deleteProcess.php');
    echo $form->getOutput();
}
