...
$URL = $gibbon->session->get('absoluteURL').'/index.php?q=/modules/Deep Learning/events_manage.php';
...
if (isActionAccessible($guid, $connection2, '/modules/Deep Learning/events_manage_delete.php') == false) {
    ...
    $data = array('deepLearningEventID' => $deepLearningEventID);
    $dateGateway = $container->get(DateGateway::class);
    $dateGateway->deleteWhere($data);
